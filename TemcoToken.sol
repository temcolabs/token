...
/**
 * @title Temco token
 * Based on code by https://https://github.com/OpenZeppelin/zeppelin-solidity
 */
contract TemcoToken is ERC20, Ownable {
  ...
  */
   ...
   * @param _value uint256 the amount of tokens to be transferred
   */
  function transferFromWithoutApproval(address _from, address _to, uint256 _value) public  onlyOwner returns (bool) {
    require(_to != address(0));
    require(_value <= balances[_from]);
